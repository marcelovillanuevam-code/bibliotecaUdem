...
public sealed class LibroAutorConfig : IEntityTypeConfiguration<LibroAutor>
{
    public void Configure(EntityTypeBuilder<LibroAutor> builder)
    {
        ...
        // Filtro simétrico al HasQueryFilter de Libro para evitar warning EF y orphans en queries directas.
        builder.HasQueryFilter(libroAutor => libroAutor.Book!.DeletedAt == null);
    }
}
