        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_loan_renewals_users_renewed_by_user_id",
                        column: x => x.renewed_by_user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_loan_renewals_renewed_by_user_id",
                table: "loan_renewals",
                column: "renewed_by_user_id");

            migrationBuilder.CreateIndex(
                name: "idx_loans_book_copy_status",
                table: "loans",
